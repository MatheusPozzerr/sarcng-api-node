...
import { DeleteSubjectUseCaseDI, GetAllSubjectsUseCaseDI, GetSubjectUseCaseDI, PostSubjectUseCaseDI, UpdateSubjectUseCaseDI } from "../di/subject/subject.token";
...
export class SubjectController{
    ...
    @Put(':id')
    putSubject(@Param('id') id: number, @Body() subject: Subject): Promise<SubjectDto>{
