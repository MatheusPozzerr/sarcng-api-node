...
export class SequelizeSubjectRepositoryAdapter
  implements SubjectRepositoryPort
{
  ...
  async getSubjects(query: SubjectModelWhere): Promise<Subject[]> {
    return await this.subjectRepository
      .findAll<SubjectModel>({ where: { ...query } })
      .then((subjects) => {
